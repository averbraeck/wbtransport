 ...
 */
public class SegmentR extends RoadSegment
{
    /** */
     ...
     */
    public SegmentR(Network network, String id, Road road, LRP startNode, LRP endNode, LinkType linkType, OTSLine3D designLine,
