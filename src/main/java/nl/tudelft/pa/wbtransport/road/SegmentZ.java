 ...
 */
public class SegmentZ extends RoadSegment
{
    /** */
     ...
     * @param parameters params about flood
     * @throws NetworkException if link already exists in the network, if name of the link is not unique, or if the start node
     *             or the end node of the link are not registered in the network.
     */
    public SegmentZ(Network network, String id, Road road, LRP startNode, LRP endNode, LinkType linkType, OTSLine3D designLine,
            OTSSimulatorInterface simulator, LongitudinalDirectionality directionality, final Gap gap,
            final Map<String, Object> parameters) throws NetworkException
    {
        super(network, id, road, startNode, endNode, linkType, designLine, simulator, directionality, gap, parameters);
    }
