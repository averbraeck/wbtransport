...
/**
 * <br>
 * Copyright (c) 2012 Delft University of Technology, Jaffalaan 5, 2628 BX Delft, the Netherlands. All rights reserved. See for
 * project information <a href="http://www.simulation.tudelft.nl/"> www.simulation.tudelft.nl</a>. The source code and binary
 * code of this software is proprietary information of Delft University of Technology.
...
public class TestGISDisplayRoutes
{
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        map.addLayer(newLayer(map, initialDir, "waterways_53routes_routable_final_processed"));
