 ...
 */
public class PortAnimation extends Renderable2D<Port> implements Serializable
{
    /** */
     ...
     * @param port the port to draw
     * @param simulator the simulator
     * @throws NamingException in case of registration failure of the animation
     * @throws RemoteException in case of remote registration failure of the animation
     */
    public PortAnimation(final Port port, final OTSSimulatorInterface simulator) throws NamingException, RemoteException
    {
        super(port, simulator);
        this.setScale(false);

        PortTextAnimation pta =
                new PortTextAnimation(port, port.getId(), 0.0f, 14.0f, TextAlignment.CENTER, Color.BLACK, 16.0f, simulator);
        pta.setRotate(false);
        pta.setScale(false);
    }
