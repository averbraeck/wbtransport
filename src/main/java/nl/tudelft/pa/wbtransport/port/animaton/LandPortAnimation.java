package nl.tudelft.pa.wbtransport.port.animaton;
 ...
 */
public class LandPortAnimation extends Renderable2D<LandPort> implements Serializable
{
    /** */
     ...
     * @param landPort the land port to draw
     * @param simulator the simulator
     * @throws NamingException in case of registration failure of the animation
     * @throws RemoteException in case of remote registration failure of the animation
     */
    public LandPortAnimation(final LandPort landPort, final OTSSimulatorInterface simulator) throws NamingException, RemoteException
    {
        super(landPort, simulator);
        this.setScale(false);

        PortTextAnimation pta =
                new PortTextAnimation(landPort, landPort.getId(), 0.0f, 14.0f, TextAlignment.CENTER, Color.BLACK, 16.0f, simulator);
        pta.setRotate(false);
        pta.setScale(false);
    }
    ...
    /** */
    public class PortTextAnimation extends TextAnimation
    {
        /** */
         ...
         */
        public PortTextAnimation(final Locatable source, final String text, final float dx, final float dy,
        ...
        {
            return new PortTextAnimation(newSource, getText(), getDx(), getDy(), getTextAlignment(), getColor(), getFontSize(),
                    newSimulator);
        }
    }
}
