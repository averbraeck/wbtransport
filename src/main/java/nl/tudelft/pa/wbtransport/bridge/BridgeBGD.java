...
public class BridgeBGD extends Bridge
{
     ...
     */
    public BridgeBGD(String name, DirectedPoint location, String roadNo, double chainage, String condition, String type,
            double width, double length, int constructionYear, int numberOfSpans)
    {
        super(name, location);
        this.roadNo = roadNo;
    ...
    /**
     * @param condition set condition A-D
     */
